...
def create_or_update_user_token(session_id, access_token, token_type, expires_in, refresh_token):
...
def refresh_spotify_token(session_id):
    ...
    create_or_update_user_token(session_id, access_token, token_type, expires_in, refresh_token)